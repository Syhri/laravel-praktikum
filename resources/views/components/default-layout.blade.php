        ...
        <header x-class="{ open: false }"
            ...
            <div x-show="open" class="bg-white border border-zinc-300 shadow-lg sm:hidden absolute top-12 right-3">
                <ul class="flex flex-col gap-2">
                    <li x-on:click="open = !open"><a href="{{ route('dashboard') }}"
                            class="block px-4 py-2 text-zinc-600 text-sm hover:bg-gray-100">Dashboard</a></li>
                    <li x-on:click="open = !open"><a href="{{ route('students.index') }}"
                            class="block px-4 py-2 text-zinc-600 text-sm hover:bg-gray-100">Students</a></li>
                    <li x-on:click="open = !open"><a href="{{ route('students.index') }}"
                            class="block px-4 py-2 text-zinc-600 text-sm hover:bg-gray-100">Majors</a></li>
                    <li x-on:click="open = !open"><a href="{{ route('students.index') }}"
                            class="block px-4 py-2 text-zinc-600 text-sm hover:bg-gray-100">Profile</a></li>
                </ul>
            </div>
        </header>
